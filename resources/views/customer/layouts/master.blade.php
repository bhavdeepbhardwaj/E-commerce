...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="frontend/frontend/assets/images/icons/apple-touch-icon.png">
...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="page-header text-center"
                style="background-image: url('frontend/assets/images/page-header-bg.jpg')">
                <div class="container">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="tab-dashboard" role="tabpanel"
                                        ...
                                        <p>Hello <span class="font-weight-normal text-dark">{{ Auth::User()->full_name }}</span>
                                            <br>
                                    ...
                                    <div class="tab-pane fade" id="tab-account" role="tabpanel"
                                        ...
                                        <form action="#">
                                            ...
                                            <input type="text" class="form-control" required>
                                            <small class="form-text">This will be how your name will be displayed
    ...
    @include('customer.component.sign_in_sign_up')
    <!-- End .modal -->
...
<!-- molla/dashboard.html  04 May 2022 10:03:13 GMT -->
