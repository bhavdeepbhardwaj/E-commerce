                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="responsive-data-table" class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img class="cat-thumb" src="/backend/assets/img/category/clothes.png" alt="Product Image" /></td>
                                        <td>Clothes</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="/backend/assets/img/category/footwear.png" alt="Product Image" /></td>
                                        <td>Footwear</td>
                                        <td>
                                            <span class="ec-sub-cat-list">
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="/backend/assets/img/category/jewelry.png" alt="Product Image" /></td>
                                        <td>Jewelry</td>
                                        <td>
                                            <span class="ec-sub-cat-list">
                                                <span class="ec-sub-cat-count" title="Total Sub Categories">4</span>
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="/backend/assets/img/category/perfume.png" alt="Product Image" /></td>
                                        <td>Perfume</td>
                                        <td>
                                            <span class="ec-sub-cat-list">
                                                <span class="ec-sub-cat-count" title="Total Sub Categories">4</span>
                                    ...
                                    <tr>
                                        <td><img class="cat-thumb" src="/backend/assets/img/category/cosmetics.png" alt="Product Image" /></td>
                                        <td>Cosmetics</td>
                                        <td>
                                            <span class="ec-sub-cat-list">
